...
public final class CA {
     ...
     *
     * @param subject Subject's Distinguished Name
     ...
     *
     * @param keystorePath path of the PKCS12 keystore
     * @param password     password of the keystore
     * @param alias        Root certificate alias in the keystore
     ...
     * Loads an existing {@link RootCertificate} from a {@code PKCS12} keystore.
     *
     * @param keystoreFile PKCS12 keystore file
     * @param password     password of the keystore
     * @param alias        Root certificate alias in the keystore
     * @return the loaded {@link RootCertificate}
     */
     ...
     * Loads an existing {@link RootCertificate} from a {@code PKCS12} keystore.
     *
     * @param keystore PKCS12 keystore, already "loaded"
     * @param alias        Root certificate alias in the keystore
     * @return the loaded {@link RootCertificate}
     */
    public static RootCertificate loadRootCertificate(final KeyStore keystore,
                                                      final String alias, final char[] password) {
        return RootCertificateLoader.loadRootCertificate(keystore, alias, password);
    }
     ...
     * Loads a {@link CSR} (Certificate Signing Request) from a file.
     *
     * @param csrFileName CSR file path
     * @return the CSR object
     */
