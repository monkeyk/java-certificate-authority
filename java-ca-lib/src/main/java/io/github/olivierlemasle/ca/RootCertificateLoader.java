...
final class RootCertificateLoader {
    ...
    static RootCertificateImpl loadRootCertificate(final File keystoreFile,
        ...
        try {
            ...
            try (InputStream stream = new FileInputStream(keystoreFile)) {
                ...
                return loadRootCertificate(keystore, alias, password);
            }
    ...
    static RootCertificateImpl loadRootCertificate(final KeyStore keystore, final String alias, final char[] password) {
        try {
